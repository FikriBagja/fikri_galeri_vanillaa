...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center align-items-center h-screen mt-5">
            <div class="col-md-6">
                <div class="profile-card p-4 shadow-lg rounded bg-light" style="margin-top: 90px;">
                    <h3 class="text-center text-bold mb-3">Selamat Datang Di Fikri Galeri</h3>
                    <h5 class="text-center text-secondary">Temukan koleksi foto-foto terbaik kami. Silakan masuk untuk memulai atau daftar jika belum memiliki akun.</h5>
