...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jan 2025 pada 15.39
...
(36, 1, 3, 'dimana itu kak?', '2025-01-26', NULL),
(37, 3, 3, 'htm nya berapa kak?', '2025-01-26', NULL),
(38, 3, 1, 'aku kemarin 50rb ka', '2025-01-26', 37),
(39, 15, 3, 'tes', '2025-01-29', NULL),
(40, 15, 2, 'test', '2025-01-29', 39),
(41, 18, 1, 'yang ytta ytta ajah', '2025-01-29', NULL),
(42, 1, 3, 'bagus', '2025-01-29', NULL),
(43, 16, 2, 'wow', '2025-01-29', NULL);
...
--
ALTER TABLE `likefoto`
  MODIFY `likeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
